...
const TEAM_SCHEDULES = [
  /* -------------------------- SUN BELT -------------------------- */
  {
    ...
    weeks: [
      ...
      { week: 2, opponent: "South Carolina", location: "at", teamScore: 7, opponentScore: 35 },
      { week: 3, opponent: "Ohio", location: "vs", teamScore: 45, opponentScore: 24 },
      { week: 4, note: "BYE" },
      { week: 5, opponent: "Ole Miss", location: "at", teamScore: 10, opponentScore: 7 },
      { week: 6, opponent: "Southern Mississippi", location: "vs", teamScore: 27, opponentScore: 17 },
      { week: 7, opponent: "Old Dominion", location: "vs", teamScore: 21, opponentScore: 10 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 3, opponent: "Memphis", location: "vs", teamScore: 35, opponentScore: 30 },
      { week: 4, opponent: "Northern Illinois", location: "vs", teamScore: 45, opponentScore: 10 },
      { week: 5, opponent: "Coastal Carolina", location: "vs", teamScore: 38, opponentScore: 10 },
      { week: 6, opponent: "Georgia State", location: "at", teamScore: 35, opponentScore: 16 },
      { week: 7, opponent: "Southern Mississippi", location: "at", teamScore: 49, opponentScore: 17 },
      { week: 8, opponent: "Marshall", location: "vs", teamScore: 42, opponentScore: 3 },
      { week: 9, opponent: "Louisiana Tech", location: "vs", teamScore: 56, opponentScore: 3 },
      { week: 10, note: "BYE" },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 3, opponent: "Patriot Tech", location: "at", teamScore: 28, opponentScore: 31 },
      { week: 4, opponent: "FCS East", location: "vs", teamScore: 56, opponentScore: 0 },
      { week: 5, note: "BYE" },
      { week: 6, opponent: "James Madison", location: "at", teamScore: 23, opponentScore: 26 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 3, opponent: "Westeros", location: "at", teamScore: 17, opponentScore: 16 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 3, opponent: "FCS Midwest", location: "vs", teamScore: 42, opponentScore: 10 },
      { week: 4, note: "BYE" },
      ...
      { week: 8, opponent: "UMass", location: "vs", teamScore: 12, opponentScore: 13 },
  ...
  /* ---------------------------- CUSA --------------------------- */
  {
    ...
    weeks: [
      ...
      { week: 7, note: "BYE" },
      { week: 8, opponent: "Middle Tennessee", location: "at", teamScore: 17, opponentScore: 13 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 2, opponent: "Louisville", location: "at", teamScore: 34, opponentScore: 27 },
      { week: 3, opponent: "Florida Atlantic", location: "vs", teamScore: 14, opponentScore: 16 },
      { week: 4, note: "BYE" },
      { week: 5, opponent: "FCS East", location: "vs", teamScore: 41, opponentScore: 14 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 3, opponent: "New Glarus", location: "vs", teamScore: 16, opponentScore: 17 },
      { week: 4, opponent: "Patriot Tech", location: "at", teamScore: 34, opponentScore: 0 },
      { week: 5, opponent: "BYU", location: "at", teamScore: 18, opponentScore: 31 },
