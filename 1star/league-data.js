...
/* ------------------------------------------------------------
   ...
   ------------------------------------------------------------ */
const COACHES = [
  { name: "BluBus",     team: "Dillon Panthers",             conference: "Sun Belt", color: "#5990E3", twitch: "", logo: "logos/dillon-panthers.png",            location: "Dillon, TX",      replacing: "Georgia Southern" },
  { name: "Alex",       team: "North Shore Fighting Moose",  conference: "MAC",      color: "#4FAE6E", twitch: "", logo: "logos/north-shore-fighting-moose.png", location: "Duluth, MN",      replacing: "Akron" },
  { name: "Dway",       team: "Minneapolis Monsters",        conference: "MAC",      color: "#C3E63F", twitch: "", logo: "logos/minneapolis-monsters.png",       location: "Minneapolis, MN", replacing: "Kent State" },
  ...
  { name: "Bl00dVayN3", team: "Westeros White Walkers",      conference: "CUSA",     color: "#A8D5E8", twitch: "", logo: "logos/westeros-white-walkers.png",     location: "Boise, ID",       replacing: "Western Kentucky" },
  ...
  { name: "Brian52682", team: "Patriot Tech Minutemen",      conference: "CUSA",     color: "#DE4B5C", twitch: "", logo: "logos/patriot-tech-minutemen.png",     location: "",                replacing: "Liberty" },
