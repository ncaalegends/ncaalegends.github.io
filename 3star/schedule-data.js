...
const TEAM_SCHEDULES = [
  /* ---------------------------- ACC ---------------------------- */
  {
    ...
    weeks: [
      ...
      { week: 6, opponent: "SMU", location: "vs", stadium: "California Memorial Stadium", teamScore: 33, opponentScore: 30 },
      { week: 7, opponent: "Pittsburgh", location: "vs", stadium: "California Memorial Stadium", teamScore: 0, opponentScore: 29 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 3, opponent: "Georgia Tech", location: "at", stadium: "Bobby Dodd Stadium", teamScore: 31, opponentScore: 0 },
      { week: 4, opponent: "Florida State", location: "at", stadium: "Doak Campbell Stadium", teamScore: 63, opponentScore: 7 },
      { week: 5, note: "BYE" },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 8, opponent: "Washington", location: "vs", stadium: "North Dakota State Stadium", teamScore: 38, opponentScore: 17 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 7, opponent: "Purdue", location: "vs", stadium: "SHI Stadium", teamScore: 42, opponentScore: 17 },
      { week: 8, note: "BYE" },
  ...
  /* ---------------------------- XII ---------------------------- */
  {
    ...
    weeks: [
      ...
      { week: 5, note: "BYE" },
      { week: 6, opponent: "Texas Tech", location: "at", stadium: "Jones Stadium", teamScore: 52, opponentScore: 34 },
      { week: 7, note: "BYE" },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 3, opponent: "NIU", location: "vs", stadium: "Folsom Field", teamScore: 35, opponentScore: 7 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 3, opponent: "Tennessee", location: "vs", stadium: "Jack Trice Stadium", teamScore: 27, opponentScore: 21 },
      { week: 4, opponent: "Arizona", location: "vs", stadium: "Jack Trice Stadium", teamScore: 24, opponentScore: 20 },
      { week: 5, opponent: "Oklahoma State", location: "at", stadium: "Boone Pickens Stadium", teamScore: 31, opponentScore: 28 },
      { week: 6, note: "BYE" },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 2, opponent: "Kansas", location: "vs", stadium: "Boone Pickens Stadium", teamScore: 41, opponentScore: 30 },
      { week: 3, opponent: "Texas A&M", location: "vs", stadium: "Boone Pickens Stadium", teamScore: 24, opponentScore: 14 },
      { week: 4, note: "BYE" },
      ...
      { week: 8, opponent: "Tulsa", location: "vs", stadium: "Boone Pickens Stadium", teamScore: 28, opponentScore: 17 },
  ...
  /* ---------------------------- SEC ---------------------------- */
  {
    ...
    weeks: [
      ...
      { week: 5, opponent: "App St.", location: "vs", stadium: "Jerry Richardson Stadium", teamScore: 17, opponentScore: 10 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 8, opponent: "Tennessee", location: "vs", stadium: "Bridgeforth Stadium", teamScore: 42, opponentScore: 28 },
  ...
  },
  {
    ...
    weeks: [
      { week: 0, opponent: "UAB", location: "vs", stadium: "Acrisure Bounce House", teamScore: 37, opponentScore: 21 },
      { week: 1, opponent: "California", location: "vs", stadium: "Acrisure Bounce House", teamScore: 41, opponentScore: 22 },
      { week: 2, note: "BYE" },
      { week: 3, opponent: "East Carolina", location: "at", stadium: "Dowdy-Ficklen Stadium", teamScore: 37, opponentScore: 21 },
