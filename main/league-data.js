...
const SEASON = {
  ...
  nextAdvanceAt: "2026-08-22T22:00:00-04:00",
  nextAdvance: "Saturday, August 22nd - 10:00 PM EDT",
};
...
const COACHES = [
  ...
  { name: "Trick whitey",    team: "Alabama",                      conference: "SEC", color: "#C7304A", twitch: "https://www.twitch.tv/trickwhitey44", espnId: "333", joinedAtWeek: 11 },  // Took Alabama over from Woogity, who left after week 4. Weeks 0-4 are Woogity's head-to-head games and stay his; weeks 5-10 belong to nobody and stay CPU — in particular Miles's Week 6 win over Alabama is NOT a head-to-head result. Also plays Maryland in the 3-star dynasty: one Twitch, one shared entry in tools/config.json for Discord pings.
