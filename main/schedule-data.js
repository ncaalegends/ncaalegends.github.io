...
const TEAM_SCHEDULES = [
  {
    ...
    weeks: [
      ...
      { week: 3, opponent: "Air Force", location: "vs", stadium: "California Memorial Stadium", teamScore: 58, opponentScore: 16 },
      { week: 4, note: "BYE" },
      { week: 5, opponent: "Wake Forest", location: "vs", stadium: "California Memorial Stadium", teamScore: 41, opponentScore: 22 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 3, opponent: "Notre Dame", location: "vs", stadium: "Amon G. Carter Stadium", teamScore: 24, opponentScore: 16 },
      { week: 4, opponent: "Arkansas", location: "vs", stadium: "Amon G. Carter Stadium", teamScore: 22, opponentScore: 19 },
      { week: 5, opponent: "Oklahoma State", location: "at", stadium: "Boone Pickens Stadium", teamScore: 41, opponentScore: 24 },
      { week: 6, opponent: "Utah", location: "at", stadium: "Rice-Eccles Stadium", teamScore: 48, opponentScore: 20 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 3, opponent: "Georgia", location: "at", stadium: "Sanford Stadium", teamScore: 48, opponentScore: 38 },
      { week: 4, opponent: "Syracuse", location: "vs", stadium: "Clemson Memorial Stadium", teamScore: 62, opponentScore: 14 },
      { week: 5, opponent: "Louisville", location: "vs", stadium: "Clemson Memorial Stadium", teamScore: 52, opponentScore: 7 },
      { week: 6, opponent: "Florida State", location: "vs", stadium: "Clemson Memorial Stadium", teamScore: 34, opponentScore: 14 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 3, opponent: "South Carolina", location: "vs", stadium: "Ben Hill Griffin Stadium", teamScore: 30, opponentScore: 7 },
      { week: 4, opponent: "Missouri", location: "at", stadium: "Faurot Field at Memorial Stadium", teamScore: 27, opponentScore: 19 },
      { week: 5, opponent: "North Carolina", location: "vs", stadium: "Ben Hill Griffin Stadium", teamScore: 40, opponentScore: 22 },
      { week: 6, opponent: "Vanderbilt", location: "vs", stadium: "Ben Hill Griffin Stadium", teamScore: 66, opponentScore: 3 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 3, opponent: "Oregon State", location: "vs", stadium: "Autzen Stadium", teamScore: 51, opponentScore: 9 },
      { week: 4, opponent: "Michigan", location: "at", stadium: "Michigan Stadium", teamScore: 38, opponentScore: 14 },
      { week: 5, opponent: "Notre Dame", location: "at", stadium: "Notre Dame Stadium", teamScore: 35, opponentScore: 32 },
      { week: 6, note: "BYE" },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 2, note: "BYE" },
      { week: 3, opponent: "Tennessee", location: "vs", stadium: "Doak Campbell Stadium", teamScore: 47, opponentScore: 21 },
      { week: 4, opponent: "Pittsburgh", location: "vs", stadium: "Doak Campbell Stadium", teamScore: 35, opponentScore: 0 },
      { week: 5, opponent: "Miami", location: "vs", stadium: "Doak Campbell Stadium", teamScore: 10, opponentScore: 28 },
      { week: 6, opponent: "Clemson", location: "at", stadium: "Clemson Memorial Stadium", teamScore: 14, opponentScore: 34 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 5, note: "BYE" },
      { week: 6, opponent: "Michigan State", location: "vs", stadium: "Husky Stadium", teamScore: 59, opponentScore: 28 },
      { week: 7, note: "BYE" },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 2, note: "BYE" },
      { week: 3, opponent: "Florida", location: "at", stadium: "Ben Hill Griffin Stadium", teamScore: 7, opponentScore: 30 },
      { week: 4, opponent: "UCF", location: "vs", stadium: "Williams-Brice Stadium", teamScore: 31, opponentScore: 35 },
      { week: 5, opponent: "Kentucky", location: "vs", stadium: "Williams-Brice Stadium", teamScore: 31, opponentScore: 34 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 3, opponent: "Marshall", location: "vs", stadium: "Ohio Stadium", teamScore: 45, opponentScore: 3 },
      { week: 4, opponent: "Minnesota", location: "at", stadium: "Huntington Bank Stadium", teamScore: 42, opponentScore: 35 },
      { week: 5, note: "BYE" },
      { week: 6, opponent: "Nebraska", location: "vs", stadium: "Ohio Stadium", teamScore: 42, opponentScore: 14 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 3, opponent: "Alabama", location: "at", stadium: "Saban Field at Bryant-Denny Stadium", teamScore: 48, opponentScore: 17 },
      { week: 4, opponent: "Tennessee", location: "at", stadium: "Neyland Stadium", teamScore: 35, opponentScore: 3 },
      { week: 5, opponent: "Auburn", location: "at", stadium: "Jordan-Hare Stadium", teamScore: 56, opponentScore: 17 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 3, opponent: "Clemson", location: "vs", stadium: "Sanford Stadium", teamScore: 38, opponentScore: 48 },
      { week: 4, note: "BYE" },
      { week: 5, opponent: "Texas A&M", location: "vs", stadium: "Sanford Stadium", teamScore: 21, opponentScore: 28 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 3, opponent: "E. Michigan", location: "vs", stadium: "Michigan Stadium", teamScore: 52, opponentScore: 9 },
      { week: 4, opponent: "Oregon", location: "vs", stadium: "Michigan Stadium", teamScore: 14, opponentScore: 38 },
      { week: 5, opponent: "Indiana", location: "at", stadium: "Memorial Stadium", teamScore: 49, opponentScore: 17 },
      { week: 6, opponent: "Penn State", location: "at", stadium: "West Shore Home Field at Beaver Stadium", teamScore: 42, opponentScore: 24 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 3, opponent: "Oklahoma State", location: "at", stadium: "Boone Pickens Stadium", teamScore: 45, opponentScore: 6 },
      { week: 4, opponent: "Arizona State", location: "vs", stadium: "Milan Puskar Stadium", teamScore: 31, opponentScore: 20 },
      { week: 5, opponent: "Baylor", location: "at", stadium: "McLane Stadium", teamScore: 48, opponentScore: 20 },
      { week: 6, note: "BYE" },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 3, note: "BYE" },
      { week: 4, opponent: "Iowa State", location: "at", stadium: "Jack Trice Stadium", teamScore: 63, opponentScore: 7 },
      { week: 5, opponent: "Houston", location: "at", stadium: "TDECU Stadium", teamScore: 41, opponentScore: 7 },
      { week: 6, opponent: "Arizona", location: "at", stadium: "Casino Del Sol Stadium", teamScore: 41, opponentScore: 10 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 3, opponent: "North Carolina", location: "at", stadium: "Kenan Stadium", teamScore: 28, opponentScore: 27 },
      { week: 4, opponent: "Duke", location: "at", stadium: "Wallace Wade Stadium", teamScore: 44, opponentScore: 17 },
      { week: 5, opponent: "California", location: "at", stadium: "California Memorial Stadium", teamScore: 22, opponentScore: 41 },
      { week: 6, opponent: "Notre Dame", location: "vs", stadium: "Allegacy Federal Credit Union Stadium", teamScore: 20, opponentScore: 27 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 2, note: "BYE" },
      { week: 3, opponent: "Purdue", location: "at", stadium: "Ross-Ade Stadium", teamScore: 31, opponentScore: 9 },
      { week: 4, opponent: "Iowa", location: "at", stadium: "Kinnick Stadium", teamScore: 38, opponentScore: 24 },
      { week: 5, opponent: "Northwestern", location: "vs", stadium: "Rose Bowl Stadium", teamScore: 48, opponentScore: 3 },
      { week: 6, opponent: "Fresno State", location: "vs", stadium: "Rose Bowl Stadium", teamScore: 35, opponentScore: 9 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 3, opponent: "New Mexico St.", location: "vs", stadium: "Hard Rock Stadium", teamScore: 32, opponentScore: 16 },
      { week: 4, note: "BYE" },
      { week: 5, opponent: "Florida State", location: "at", stadium: "Doak Campbell Stadium", teamScore: 28, opponentScore: 10 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 3, opponent: "TCU", location: "at", stadium: "Amon G. Carter Stadium", teamScore: 16, opponentScore: 24 },
      { week: 4, opponent: "Washington", location: "at", stadium: "Husky Stadium", teamScore: 63, opponentScore: 27 },
      { week: 5, opponent: "Oregon", location: "vs", stadium: "Notre Dame Stadium", teamScore: 32, opponentScore: 35 },
      { week: 6, opponent: "Wake Forest", location: "at", stadium: "Allegacy Federal Credit Union Stadium", teamScore: 27, opponentScore: 20 },
  ...
  },
  {
    ...
    weeks: [
      ...
      { week: 6, opponent: "Tennessee", location: "vs", stadium: "Tiger Stadium", teamScore: 31, opponentScore: 28 },
